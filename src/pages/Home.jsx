  ...
  Bengaluru: [
    {
      ...
      emoji: "🌳",
      tagline: "Heritage, culture & food within 5km",
      color: "#10B981",
      budget: "2,600-5,500 per person",
      stops: [
        { time: "8:00-9:00 AM", place: "Konark Kanteerava", type: "Breakfast", note: "Benne dosa, idli-vada, kesari bath & filter coffee right beside Cubbon Park", cost: "200-350" },
        { time: "9:00-10:30 AM", place: "Cubbon Park", type: "Nature", note: "Walk through bamboo groves, bandstand & red Central Library. One of Bengaluru's largest green spaces", cost: "Free" },
        ...
        { time: "1:15-2:45 PM", place: "Karavalli Restaurant Bangalore", type: "Lunch", note: "Finest coastal South Indian meals. Reservation recommended. Or try Smoke House Deli for Continental", cost: "800-2,000" },
        ...
        { time: "7:30-9:30 PM", place: "Spice Terrace Bangalore", type: "Dinner", note: "Rooftop North Indian dining or try Cafe Noir at UB City for European-style dinner", cost: "1,200-2,500" },
      ],
    },
    { id: "blr-b", title: "Plan B", emoji: "📍", tagline: "Coming soon", color: "#F59E0B", budget: null, stops: [] },
    { id: "blr-c", title: "Plan C", emoji: "📍", tagline: "Coming soon", color: "#8B5CF6", budget: null, stops: [] },
    { id: "blr-d", title: "Plan D", emoji: "📍", tagline: "Coming soon", color: "#EF4444", budget: null, stops: [] },
    { id: "blr-e", title: "Plan E", emoji: "📍", tagline: "Coming soon", color: "#06B6D4", budget: null, stops: [] },
    { id: "blr-f", title: "Plan F", emoji: "📍", tagline: "Coming soon", color: "#EC4899", budget: null, stops: [] },
  ],
  Chennai: [
